...
public class TestTool
{
    ...
    public static final String ExamTableName = "WMEtest";
    public final static String mGoogleSpreadSheetUrl = "https://docs.google.com/spreadsheets/d/1Nf1JxMtarsM3eMnV8DdtgUyxpbaWHHssJrJ9tuDjlRo/pubhtml?gid=2083388638&single=true";

    public static boolean fileExists()
    {
        return new File(ClassTool.mFilePath + ExamDBName).exists();
    }

    public static examData getExamInfoData()
    {
        Database mDatabase = new Database();
        mDatabase.openDatabase(ClassTool.mFilePath, ExamDBName);
